...
# Create WOdka Folder (WOFrameworksRepository/WOdka/Library/Frameworks)
mkdir -p ${WODKA_FRAMEWORKS_IN_FRAMEWORKS_REPOSITORY}
...
for PROJECT in $PROJECTS; do
	...
	ln -sfn ${WONDER_FRAMEWORKS_IN_FRAMEWORKS_REPOSITORY}/${PROJECT} ${WODKA_FRAMEWORKS_IN_FRAMEWORKS_REPOSITORY}
